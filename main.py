...
def main(config):
	...
	if config.mode == 'train':  # train mode
		...
		logger('Time: {},  base, Dataset: Duke  \nmAP: {} Rank@1:{} Rank@2:{} Rank@3:{} Rank@5:{} Rank@10:{}'.format(
			time_now(), duke_map, duke_rank[0], duke_rank[1], duke_rank[2], duke_rank[4], duke_rank[9]))
		# duke_map, duke_rank = testwithVer2(config, logger, base, loaders, 'duke', use_gcn=False, use_gm=True)
		# logger('Time: {},  base+gm, Dataset: Duke  \nmAP: {} \nRank: {}'.format(time_now(), duke_map, duke_rank))
		logger('')
...
if __name__ == '__main__':
	...
	parser.add_argument('--train_dataset', type=str, default='duke', help='duck or market')
	...
	# train configuration
	parser.add_argument('--milestones', nargs='+', type=int, default=[40, 70], help='转折点 milestones for the learning rate decay')
